import { chainHex, chainId, tokenContractAddress, http, NFTContractAdress } from '../config/site.config'
...
const getNFTContractInstance = (web3) => {
  // const web3 = new Web3(new Web3.providers.HttpProvider(http));
  let res = new web3.eth.Contract(NFTABI, NFTContractAdress); // contact
  return res
}

const getTokenContractInstance = (web3) => {
  // const web3 = new Web3(new Web3.providers.HttpProvider(http));
  let res = new web3.eth.Contract(TOKENABI, tokenContractAddress); // main
  return res
}
// const getWeb3 = () => {
//   const web3 = new Web3(new Web3.providers.HttpProvider(http));
